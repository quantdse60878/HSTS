...
var DEFAULT_URL = '/static/plugins/pdf.js/web/compressed.tracemonkey-pldi-09.pdf';
...
PDFJS.imageResourcesPath = '../static/plugins/pdf.js/web/images/';
PDFJS.workerSrc = '/static/plugins/pdf.js/build/pdf.worker.js';
PDFJS.cMapUrl = '/static/plugins/pdf.js/web/cmaps/';
...
function webViewerInitialized() {
  /**
   * Override value of file to render data
   * @type {Element}
   */
  ...
  console.log(pdfLink);
  var file = pdfLink != ""? pdfLink: DEFAULT_URL;
  /**
   *
   */
